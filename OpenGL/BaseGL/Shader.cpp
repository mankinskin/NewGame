...
unsigned int gl::Shader::createModule(string pFileName)
{
	unsigned int index = allModules.size();
	moduleLookup.insert(std::pair<string, unsigned>(pFileName, index));
	allModules.push_back(Module(pFileName));
	return index;
}

unsigned int gl::Shader::newProgram(string pProgramName, unsigned int pVertexShaderIndex, unsigned int pFragmentShaderIndex)
{
...
unsigned int gl::Shader::newProgram(string pProgramName, unsigned int pVertexShaderIndex, unsigned int pFragmentShaderIndex, unsigned int pGeometryShaderIndex)
{
	unsigned int index = createProgram(pProgramName);
...
unsigned int gl::Shader::newProgram(string pProgramName, unsigned int pComputeShaderIndex)
{
...
unsigned int gl::Shader::createProgram(string pProgramName)
{
	Program program;
	program.ID = glCreateProgram();
	program.name = pProgramName;
	shaderProgramLookup.insert(std::pair<string, unsigned>(pProgramName, program.ID));

...
unsigned int buttonBuffer;
unsigned int buttonIndexShader;
std::vector<int> allButtonFlags;
std::vector<unsigned int> allButtonQuads;
std::vector<unsigned int> buttonIndexMap;
...
unsigned int gl::GUI::readButtonIndexMap(unsigned int pPos) {
	return buttonIndexMap[pPos];
}
unsigned int gl::GUI::readButtonIndexMap(unsigned int pXPos, unsigned int pYPos) {

...
size_t gl::Lighting::lightVAO = 0;
size_t gl::Lighting::lightIndexVBO = 0;
size_t gl::Lighting::lightDataUBO = 0;
size_t gl::Lighting::lightShaderProgram = 0;
size_t gl::Lighting::MAX_LIGHT_COUNT = 100;
...
void gl::Lighting::setLightPos(size_t pLightIndex, glm::vec3& pPos) {
    std::memcpy(&allLightData[allLightIndexRanges[pLightIndex].offset], &pPos, sizeof(float) * 3);
}
void gl::Lighting::setLightPos(size_t pLightIndex, glm::vec4& pPos) {
    std::memcpy(&allLightData[allLightIndexRanges[pLightIndex].offset], &pPos, sizeof(float) * 4);
}
void gl::Lighting::setLightColor(size_t pLightIndex, glm::vec3& pColor) {
